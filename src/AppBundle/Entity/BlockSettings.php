...
class BlockSettings
{
     ...
     * @var string
     *
     * @ORM\Column(name="picture_align_hor", type="string", length=255, columnDefinition="enum('left', 'center', 'right')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="picture_align_ver", type="string", length=255, columnDefinition="enum('top', 'middle', 'bottom')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="header_align_hor", type="string", length=255, columnDefinition="enum('left', 'center', 'right')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="header_align_ver", type="string", length=255, columnDefinition="enum('top', 'middle', 'bottom')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="header_font_hover_style", type="string", length=255, columnDefinition="enum('underline', 'bold', 'italic')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="more_txt", type="string", length=255, nullable=true)
     */
    private $moreTxt;
     ...
     * @var string
     *
     * @ORM\Column(name="more_position", type="string", length=255, columnDefinition="enum('up', 'down', 'img_up', 'img_down', 'left_up', 'left_down', 'right_up', 'right_down')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="more_btn_align_hor", type="string", length=255, columnDefinition="enum('left', 'center', 'right')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="more_btn_align_ver", type="string", length=255, columnDefinition="enum('top', 'middle', 'bottom')", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="more_txt_font_hover_color", type="string", length=255, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="more_txt_font_hover_style", type="string", length=255, columnDefinition="enum('underline', 'bold', 'italic')", nullable=true)
     */
